...
**Plans:** 5 plans
Plans:
- [ ] 03-01-PLAN.md — Encode claim granularity rules (D-01–D-05), append-then-synthesize update policy (D-06–D-10), and normalize book-chapter source type into AGENTS.md (sections 9, 10, 11.1)
