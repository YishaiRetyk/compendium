...
- [ ] **Phase 25: Parallel Migration + Cutover** (1/7 plans; decomposed 2026-07-03) — MIG-01..06, CUT-01, TEST-06
  - [x] 25-01: brownfield port (MIG-01 — architectural template; wave 1) — completed 2026-07-04; surfaced + fixed the D-09 seam rebase (normalized tree hashing; first live channel comparison)
