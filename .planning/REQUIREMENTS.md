...
- [ ] **PDF-04**: End-to-end validation: one real PDF acquired → ingested → wiki pages with page-anchored provenance, exercising the bundle convention (original PDF co-located as asset)
