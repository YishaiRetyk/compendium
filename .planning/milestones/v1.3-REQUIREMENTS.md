...
- [x] **VID-04**: End-to-end validation: one real YouTube video acquired via the pipeline → ingested → wiki pages with timestamp-anchored provenance
