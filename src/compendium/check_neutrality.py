# src/compendium/check_neutrality.py  (STUB — Phase 24; filled in Phase 25 MIG-03)
import sys
...
def main(argv=None):
    ...
    print("compendium.check_neutrality: not yet implemented (Phase 25)", file=sys.stderr)
