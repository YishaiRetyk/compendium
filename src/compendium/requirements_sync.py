# src/compendium/requirements_sync.py  (STUB — Phase 24; filled in Phase 25 MIG-05)
import sys
...
def main(argv=None):
    ...
    print("compendium.requirements_sync: not yet implemented (Phase 25)", file=sys.stderr)
