...
type: source
status: active
summary: "Direct repository inspection capturing TradingAgents' shipped market_analyst
  and fundamentals_analyst agents, their bound tools, and the LangGraph orchestration."
