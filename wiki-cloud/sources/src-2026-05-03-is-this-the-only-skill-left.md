...
type: source
status: active
summary: "Hack argues that systems thinking — once a skill senior devs accumulated
  over years — is now a day-one requirement for anyone building software with AI,
  and that prompting is the wrong layer to optimize."
