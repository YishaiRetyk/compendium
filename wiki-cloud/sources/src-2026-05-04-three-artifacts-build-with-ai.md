...
type: source
status: active
summary: "Hack argues that Domain-Driven Design — stripped to three artifacts (ubiquitous
  language, bounded contexts, documented contracts) — is the practical method for
  operationalizing systems thinking when building software with AI."
