...
- Applied to dAMD, Robin proposed enhancing RPE phagocytosis and identified ripasudil and KL001 as phagocytosis enhancers in preclinical in-vitro assays, with ripasudil being a repurposing candidate (an approved glaucoma ROCK inhibitor never previously proposed for dAMD). These are preclinical/in-vitro findings reported by this Nature accelerated-article-preview, not clinically validated treatments. [prov:src-2026-06-12-multi-agent-scientific-discovery#p3|direct|2026-06-12] [epistemic:: sourced]
- A follow-up RNA-seq experiment proposed and analyzed by Robin revealed a roughly 3-fold upregulation of ABCA1, a lipid efflux pump, which the paper interprets as a possible novel target connected to dAMD pathology (the magnitude is measured data; the dAMD-pathology connection is the paper's mechanistic interpretation). [prov:src-2026-06-12-multi-agent-scientific-discovery#p6|direct|2026-06-12] [epistemic:: inferred]
- The authors *estimate* large efficiency gains rather than measuring them in a controlled study: for one specific workflow they report Robin analyzing ~551 papers in ~30 minutes against an estimated 540 human hours, which they translate into a claimed ~200-fold time reduction; elsewhere the paper cites a related ~825-references / "over 800 hours" estimate, so 551/540 is one specific workflow figure, not a single measured benchmark. [prov:src-2026-06-12-multi-agent-scientific-discovery#p4|tentative|2026-06-12] [epistemic:: tentative]
...
- The authors *estimate* (not via a controlled time-motion study) that in the reported workflow Robin analyzed 551 papers in 30 minutes against an estimated 540 human hours, translating into an estimated ~200-fold reduction in time for the full scientific workflow; the estimate rests on published-survey reading-speed assumptions, and the paper elsewhere quotes a ~825-references / "over 800 hours" variant, so the 551/540 pair is one specific workflow estimate rather than a single measured baseline. [prov:src-2026-06-12-multi-agent-scientific-discovery#p4|tentative|2026-06-12] [epistemic:: tentative]
- A full Robin run under the paper's configuration (num_queries=5, num_assays=10, num_candidates=30) issues 45 Crow calls and 30 Falcon calls, costing on average $4.33 and $6.43 respectively, for a total of about $10.76 per run; Finch is excluded from this figure because the authors consider its once-per-iteration cost contribution negligible, so $10.76 covers only the literature-search agents under the stated configuration. [prov:src-2026-06-12-multi-agent-scientific-discovery#p5|direct|2026-06-12] [epistemic:: sourced]
- The authors' time-on-task analysis *estimates* that Robin reduces a discovery cycle from roughly 872–937 human hours to under two hours; this is a model of cognitive labor built from grant-writing and reading-speed surveys, not a measured replacement of real researchers on the task. [prov:src-2026-06-12-multi-agent-scientific-discovery#p5|tentative|2026-06-12] [epistemic:: tentative]
...
- Robin proposed treating dAMD by increasing RPE cell phagocytosis after reviewing 151 papers to rank ten candidate disease mechanisms; after selecting the phagocytosis mechanism it then ran a further literature review of ~400 papers on RPE phagocytosis and the dry-AMD therapeutic landscape *before* proposing 30 existing drug candidates for testing in a phagocytosis assay (the 151-paper step and the ~400-paper step are distinct stages). [prov:src-2026-06-12-multi-agent-scientific-discovery#p5|direct|2026-06-12] [epistemic:: sourced]
- Differential gene expression analysis (by Finch) identified a 3-fold upregulation of ABCA1 (adjusted p = 2.13×10⁻⁸³) in Y-27632-treated RPE cells; the exact-magnitude figure is reported data, but the connection of ROCK-inhibitor-induced phagocytosis to a lipid efflux pump relevant to dAMD pathology is the paper's *mechanistic interpretation*, not demonstrated causality. [prov:src-2026-06-12-multi-agent-scientific-discovery#p6|direct|2026-06-12] [epistemic:: inferred]
- Ripasudil, a ROCK inhibitor approved for glaucoma in Japan, increased RPE cell phagocytosis 1.89-fold versus DMSO controls and outperformed the research compound Y-27632; as an approved drug it carries a known safety profile that the authors frame as an advantage *relative to* the research compound Y-27632 for clinical translation (not an absolute safety claim, and these are preclinical in-vitro results). [prov:src-2026-06-12-multi-agent-scientific-discovery#p6|direct|2026-06-12] [epistemic:: sourced]
- KL001, a circadian clock modulator, was also identified as a phagocytosis-enhancing hit in primary human RPE stem cells; the authors state that, to their knowledge, no one had previously proposed KL001 as an enhancer of phagocytosis (a novelty claim qualified by the authors' own knowledge, not an exhaustive prior-art search). [prov:src-2026-06-12-multi-agent-scientific-discovery#p6|direct|2026-06-12] [epistemic:: sourced]

### Architecture validation

- In a Crow-ablation comparison where Crow (not Falcon) produces the final assay reports, the authors generated 15 assay proposals and found Crow produced no hallucinated references while 44.5 ± 6.37% (mean ± SEM, n=15) of the o4-mini substitute's references were hallucinated. This 44.5% figure is specific to those 15 Crow-ablated assay proposals — it is NOT a hallucination rate for all Robin outputs. [prov:src-2026-06-12-multi-agent-scientific-discovery#p7|direct|2026-06-12] [epistemic:: sourced]
- On a 170-item BixBench data-analysis panel, Finch scored 22.8 ± 1.7% versus 1.6 ± 1.2% for Claude Sonnet 3.7 without the agent harness. The base Sonnet 3.7 condition had no agent harness, no data access, and no code execution, so this is not a clean "same model minus tools" comparison; it bounds the value of the whole tool-augmented harness, and the authors note substantial room for improvement on multi-step problems. [prov:src-2026-06-12-multi-agent-scientific-discovery#p7|direct|2026-06-12] [epistemic:: sourced]
- A general-purpose baseline — a June 2025 ChatGPT Deep Research run given the same candidate-generation prompt — generated 17 unique candidates after de-duplication, none of which were hits in the RPE-SC assay, and it did not suggest ROCK inhibition; the authors offer this as evidence that Robin's specialized pipeline was non-trivial. [prov:src-2026-06-12-multi-agent-scientific-discovery#p7|direct|2026-06-12] [epistemic:: sourced]
...
- **Quantitative claims marked tentative:** the headline ~200-fold and 872–937-hours-to-2-hours efficiency figures are the authors' own time-on-task *estimates* built from survey-derived reading-speed and grant-writing baselines, not controlled time-motion studies, so they are graded `[epistemic:: tentative]` and their provenance support type is `tentative`. The paper also quotes a related ~825-references / "over 800 hours" variant of the same estimate. The specific cost and assay numbers ($10.76, 1.89-fold, ABCA1 magnitude, 44.5%, 22.8% vs 1.6%) are reported measurements and graded `sourced`.
- **Cost figure scope:** the ~$10.76/run cost covers 45 Crow + 30 Falcon calls under the stated configuration only; Finch is excluded because the authors treat its once-per-iteration contribution as negligible.
- **Mechanistic interpretation vs measurement:** the ABCA1 3-fold / p=2.13×10⁻⁸³ figure is measured, but tying ROCK-inhibitor phagocytosis to ABCA1-mediated dAMD pathology is the paper's interpretation (graded `[epistemic:: inferred]`), not demonstrated causality. The "favorable safety profile" of ripasudil is framed only *relative to* the research compound Y-27632, not in absolute terms.
- **Preclinical, not clinical:** all dAMD therapeutic findings (ripasudil, KL001, ABCA1) are preclinical in-vitro results reported by this Nature accelerated article preview. They are claims about what the paper reports, not independently validated facts and not clinically validated treatments. The 44.5% hallucination figure is scoped to 15 Crow-ablated assay proposals (not a blanket Robin rate); the BixBench Sonnet 3.7 baseline ran with no harness, no data access, and no code execution.
