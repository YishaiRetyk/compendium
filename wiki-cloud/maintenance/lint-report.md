...
### Duplicate
- **wiki-cloud/entities/anthropic.md** | possible duplicate of "Anthropic Financial Services" (anthropic-financial-services); same type=entity; consider MERGE (§9). Survivor by inbound-link count (9 vs 10).
- **wiki-cloud/entities/claude-api.md** | possible duplicate of "Anthropic" (anthropic); same type=entity; consider MERGE (§9). Survivor by inbound-link count (9 vs 9).
