...
type: concept
status: active
summary: "A distinct area of a system with its own rules, data, and reason for existing
  — within which a given term has a single, stable meaning."
...
A core artifact of [[domain-driven-design|Domain-Driven Design]]: a distinct area of a system with its own rules, its own data, and its own reason for existing [prov:src-2026-05-04-three-artifacts-build-with-ai#t00:07:34-00:07:52|direct|2026-05-04]. Within a bounded context, a term in the [[ubiquitous-language|Ubiquitous Language]] has one stable meaning. Across contexts, the same word may legitimately mean different things — and the contexts make that explicit.
...
- [[ubiquitous-language|Ubiquitous Language]] — sibling artifact; bounded contexts give the language its scope
- [[documented-contract|Documented Contract]] — sibling artifact; documents how contexts interact at their edges
- [[systems-thinking|Systems Thinking]] — the broader skill that judges where boundaries should fall
