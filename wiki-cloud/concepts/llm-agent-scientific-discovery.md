...
- Specialized agent harnesses materially outperform bare frontier models on the same task: Finch scored 22.8% versus 1.6% for Claude Sonnet 3.7 alone on a bioinformatics/statistics benchmark. [prov:src-2026-06-12-multi-agent-scientific-discovery#p7|direct|2026-06-12]
- Hallucinated references are a central failure mode; dedicated literature agents (Crow producing 0% hallucinated references vs 44.5% for a general LLM) act as a grounding control. [prov:src-2026-06-12-multi-agent-scientific-discovery#p7|direct|2026-06-12]
