...
type: concept
status: active
summary: "Peter Naur's 1985 argument that the program is the theory in the programmer's
  head — how the parts connect and why — and the code is just its shadow."
