...
type: overview
status: active
summary: "Specification for a custom Agent Skill that scaffolds Ralph autonomous-coding-loop
  projects by generating prompts, loop scripts, specs scaffolds, operational AGENTS.md
  guidance, and backpressure checks without running the autonomous loop itself."
