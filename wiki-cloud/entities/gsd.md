...
- Authored by TÂCHES (solo dev), first commit Dec 2025, MIT-licensed; a v2 rewrite (gsd-2) is underway as a standalone CLI on the Pi SDK for direct harness control. [prov:src-2026-04-16-claude-code-frameworks-report#sec:gsd|direct|2026-06-09] [epistemic:: tentative]
...
- Phase workflow: discuss-phase → (ui-phase or ai-integration-phase, optional) → plan-phase → execute-phase → code-review → verify-work → ship. [prov:src-2026-04-16-claude-code-frameworks-report#sec:gsd|direct|2026-06-09] [epistemic:: sourced]
...
- Strength: keeps agents on-track for hours of autonomous work, resumable across sessions and machines; weakness: rigid atomicity feels over-structured for small tasks. [prov:src-2026-04-16-claude-code-frameworks-report#sec:gsd|direct|2026-06-09] [epistemic:: sourced]
