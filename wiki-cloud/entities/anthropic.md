...
type: entity
status: active
summary: "AI safety company that builds Claude (Opus, Sonnet, Haiku model family)
  and ships three product surfaces — the Claude API, Claude Code CLI, and Claude.ai
  — plus a pre-built and Custom Agent Skills ecosystem with an open-source skills
  repository."
