...
type: decision
status: superseded
summary: "Corrects AGENTS.md §8 to state Obsidian resolves wikilinks by filename stem
  + aliases (not title); mandates self-alias invariant; adds bin/lint.sh linkres enforcement."
