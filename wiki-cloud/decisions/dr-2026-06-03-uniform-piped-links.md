...
type: decision
status: active
summary: "Corrects CLAUDE.md/AGENTS.md §8 to state Obsidian resolves wikilinks by
  filename/path ONLY (never aliases); mandates the uniform piped-link form (id target,
  title display); removes the self-alias invariant; supersedes the wrong-premise dr-2026-06-02-obsidian-filename-alias-resolution."
