...
- The 2002 Nobel citation pointed at prospect theory as a framework rather than any single experiment, recognizing the cumulative impact of the research program rather than an isolated finding. [prov:src-2026-04-10-kahneman-prospect-theory#sec:introduction|direct] [epistemic:: sourced]
- His work effectively bridged psychology and economics, creating the field now known as behavioral economics -- a characterization that reflects the cumulative impact of his research program rather than any single finding. [prov:src-2026-04-09-thinking-fast-and-slow-part1#sec:introduction|synthesis] [epistemic:: inferred]

## Detail

Kahneman's career spans more than five decades of research into how people actually think, as opposed to how rational-agent models assume they think. His early work in psychophysics and attention laid the groundwork for his later focus on judgment under uncertainty. The partnership with Tversky, which began with a seminar discussion at Hebrew University, became one of the most productive collaborations in the history of social science. Over the course of his career Kahneman held academic appointments at the Hebrew University of Jerusalem, the University of British Columbia, the University of California Berkeley, and later Princeton University. [prov:src-2026-04-10-kahneman-prospect-theory#sec:introduction|direct] [epistemic:: sourced]
