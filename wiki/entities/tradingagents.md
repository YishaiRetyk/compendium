...
type: entity
status: active
summary: "Multi-agent LLM trading research framework, orchestrated via LangGraph, with shipped market_analyst (TA via stockstats/Alpha Vantage) and fundamentals_analyst (statements via Alpha Vantage) agents plus news, sentiment, bull/bear, risk, and trader roles."
