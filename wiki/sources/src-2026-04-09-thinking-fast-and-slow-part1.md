...
- "Nothing in life is as important as you think it is, while you are thinking about it." This encapsulates the focusing illusion -- the tendency to overweight whatever is currently the focus of attention. [prov:src-2026-04-09-thinking-fast-and-slow-part1#p13|direct] [epistemic:: sourced]
- System 1 operates automatically and quickly, with little or no effort and no sense of voluntary control. System 2 allocates attention to the effortful mental activities that demand it, including complex computations. [prov:src-2026-04-09-thinking-fast-and-slow-part1#sec:two-systems|direct] [epistemic:: sourced]
- When faced with a difficult question, people often answer an easier one instead without noticing the substitution -- a process Kahneman calls "attribute substitution." [prov:src-2026-04-09-thinking-fast-and-slow-part1#p42|direct] [epistemic:: sourced]
- The anchoring effect is one of the most robust findings in experimental psychology: judgments of unknown quantities are systematically biased toward whatever number people have recently been exposed to, even when that number is obviously irrelevant. [prov:src-2026-04-09-thinking-fast-and-slow-part1#sec:heuristics|direct] [epistemic:: sourced]
