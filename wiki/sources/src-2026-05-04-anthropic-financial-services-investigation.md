...
type: source
status: active
summary: "Direct repository inspection of anthropics/financial-services-plugins confirming the repository ships populated FA SKILL.md prompts, Python validators, and Excel templates — not just instructions and configuration."
