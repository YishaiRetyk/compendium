...
type: source
status: active
summary: "Anthropic's platform documentation page introducing Agent Skills as filesystem-based directories of instructions and resources that Claude loads on demand via three-level progressive disclosure across the Claude API, Claude Code, and Claude.ai."
