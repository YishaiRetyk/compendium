...
type: source
status: active
summary: "Direct repository inspection of virattt/dexter confirming Dexter is a fundamentals-and-valuation research agent backed by the Financial Datasets API, with no technical-analysis surface."
