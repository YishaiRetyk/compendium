...
type: concept
status: active
summary: "A shared, unambiguous vocabulary for a software project — every important term defined in one sentence — used by humans, the codebase, and (in AI-coding workflows) the AI agent."
