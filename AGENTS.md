...
<!-- inclusion-audit: 290 lines @ 2026-06-14 -->
...
These are the operator procedures that implement the conceptual pipeline (the Compiler Pipeline in this document). Each workflow is a complete recipe an LLM agent follows step-by-step. The pipeline describes WHAT conceptually happens; workflows describe HOW to do it.
