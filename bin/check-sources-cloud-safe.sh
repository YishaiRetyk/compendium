#!/usr/bin/env bash
# bin/check-sources-cloud-safe.sh — exec-shim (Phase 25 MIG-03; contract: docs/reference/python-shim-contract.md §1)
...
exec python3 -m compendium.check_sources_cloud_safe "$@"
