...
- The LLM reads this FIRST when searching for information (per Section 3 and Section 7). A `wiki-local/index.md` is created lazily for local-only navigable content (D-07).
